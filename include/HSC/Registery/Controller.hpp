...
namespace hsc
{
    ...
    class RegisteredController
    {
        public:
            ...
            using ControllerCtor = std::function<std::shared_ptr<ControllerType>(std::shared_ptr<impl::AServiceProvider> &)>;
            ...
            std::shared_ptr<ControllerType> create(std::shared_ptr<impl::AServiceProvider> &_service_provider);
